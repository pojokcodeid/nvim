...
-- add by akn
maps.v["J"]={":move '>+1<CR>gv-gv", desc = "Move Bawah 1"}
maps.v["K"]={":move '<-2<CR>gv-gv", desc = "move keatas 1"}
maps.v["<A-j>"]={":move '>+1<CR>gv-gv", desc = "move kebawah 1"}
maps.v["<A-Down>"]={":move '>+1<CR>gv-gv", desc = "move kebawah 1"}
maps.v["<A-k>"]={":move '<-2<CR>gv-gv",desc = "move keatas 1"}
maps.v["<A-Up>"]={":move '<-2<CR>gv-gv", desc = "Move keatas 1"}

maps.i["<S-Down>"]={"<cmd>t.<cr>",desc ="none"}
maps.n["<S-Down>"]={"<cmd>t.<cr>",desc ="none"}
maps.n["<S-Up>"]={"<cmd>t -1<cr>",desc ="none"}
maps.i["<S-Up>"]={"<cmd>t -1<cr>",desc ="none"}
maps.n["<M-J>"]={"<cmd>t.<cr>",desc ="none"}
maps.n["<M-K>"]={"<cmd>t -1<cr>",desc ="none"}
maps.n["<M-Down>"]={"<cmd>m+<cr>",desc ="none"}
maps.i["<M-Down>"]={"<cmd>m+<cr>",desc ="none"}
maps.n["<M-Up>"]={"<cmd>m-2<cr>",desc ="none"}
maps.i["<M-Up>"]={"<cmd>m-2<cr>",desc ="none"}
maps.n["<M-j>"]={"<cmd>m+<cr>",desc ="none"}
maps.n["<M-k>"]={"<cmd>m-2<cr>",desc ="none"}
maps.i["<C-s>"]={"<cmd>w<cr>",desc ="none"}
maps.i["<C-l>"]={"<cmd>LiveServer start<cr><cr>",desc ="none"}
maps.n["q"]={"<cmd>q<cr>",desc ="none"}
maps.v["<S-Down>"]={":'<,'>t'><cr>",desc ="none"}
